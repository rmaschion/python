...
Before the interview I was asked to show how I could solve a problem...

The goal of the question is to create and test a simple web app that returns the average CPU usage on a server machine.
1 Top-Server
...
GET working on scenario described above. Finally, write tests to calculate and summarize the following performance characteristics of
...
*****REQUIREMENTS:
requests
HTML -> python has html library already pre-installed. 
The HTML solution should be installed from the zip attached.
Please, follow the instructions from readme.txt inside the zip file
